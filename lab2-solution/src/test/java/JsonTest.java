...
public class JsonTest {
    ...
    public void testArrays() {
...

        {
            ...
            String jane = "{\"typeName\": \"Person\", \"fields\": {\"firstName\": \"Jane\", \"lastName\": \"Doe\", \"sibling\": null}}";
            String john = "{\"typeName\": \"Person\", \"fields\": {\"firstName\": \"John\", \"lastName\": \"Smith\", \"sibling\": null}}";
    ...
    public void testObjects() {
        {
            ...
            String expected = "{\"typeName\": \"Person\", \"fields\": {\"firstName\": \"Jane\", \"lastName\": \"Doe\", \"sibling\": null}}";
...

        {
            ...
            String expected = "{\"typeName\": \"Dog\", \"fields\": {\"name\": \"Lassie\"}}";
    ...
    public void testRecursiveData() {
        {
            ...
            String johnStr = "{\"typeName\": \"Person\", \"fields\": {\"firstName\": \"John\", \"lastName\": \"Doe\", \"sibling\": \"Person(Jane)\"}}";
            String janeStr = "{\"typeName\": \"Person\", \"fields\": {\"firstName\": \"Jane\", \"lastName\": \"Doe\", \"sibling\": "
                    + johnStr + "}}";
    ...
    public void testRecord() {
        var p = new Point(1, 2);
        var expected = "{\"typeName\": \"Point\", \"fields\": {\"x\": 1, \"y\": 2}}";
    ...
    public void testGraph() {
        ...
        var expected = "{\"typeName\": \"Node\", \"fields\": {\"data\": 1, \"children\": [{\"typeName\": \"Node\", \"fields\": {\"data\": 2, \"children\": [\"Node(1)\"]}}]}}";
